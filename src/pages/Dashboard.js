...
function Dashboard() {
  ...
  const fetchUsers = async () => {
    try {
      const response = await axios.get(
        `https://lx-backend-61sm.onrender.com/api/users`
  ...
  const fetchWatchList1Stocks = async () => {
    try {
      const response = await axios.get(
        `https://lx-backend-61sm.onrender.com/api/watchlist1`
  ...
  const fetchWatchList2Stocks = async () => {
    try {
      const response = await axios.get(
        `https://lx-backend-61sm.onrender.com/api/watchlist2`
  ...
  const updateUserBalance = async (userId) => {
    ...
    try {
      await axios.put(
        `https://lx-backend-61sm.onrender.com/api/users/balance/${userId}`,
        {
          balance,
        }
  ...
  const addStockToWatchList1 = async () => {
    ...
    try {
      await axios.post(`https://lx-backend-61sm.onrender.com/api/watchlist1`, {
        name: newStockName1,
  ...
  const addStockToWatchList2 = async () => {
    ...
    try {
      await axios.post(`https://lx-backend-61sm.onrender.com/api/watchlist2`, {
        name: newStockName2,
  ...
  const updateStockABWatchList1 = async (stockId) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://lx-backend-61sm.onrender.com/api/watchlist1/${stockId}`,
        { A, B }
      );
  ...
  const updateStockABWatchList2 = async (stockId) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://lx-backend-61sm.onrender.com/api/watchlist2/${stockId}`,
        { A, B }
      );
  ...
  const togglePayout = async (userId, newStatus) => {
    try {
      await axios.put(
        `https://lx-backend-61sm.onrender.com/api/payout/${userId}`,
