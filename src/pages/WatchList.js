...
const WatchList1 = () => {
  ...
  const fetchStocks = async () => {
    try {
      const response = await axios.get('https://lx-backend-1-yo5e.onrender.com/api/watchlist1');
  ...
  const fetchBalance = async () => {
    ...
    try {
      const response = await axios.get(`https://lx-backend-1-yo5e.onrender.com/api/users/balance/${userId}`);
  ...
  const handleBuy = async () => {
    ...
    try {
      const response = await axios.post('https://lx-backend-1-yo5e.onrender.com/api/watchlist1/buy', {
